...
public class RecipeContoller {
    ...
    @PostMapping("/save")
    public RecipeDTO saveOrUpdateRecipe(@RequestBody RecipeDTO recipeDTO) {
      log.info(LogUtil.ENTRY, "saveOrUpdateRecipe");
      return recipeService.saveOrUpdateRecipe(recipeDTO);
    }
    ...
    public List<RecipeDTO> searchRecipes(
      ...
      return recipeService.searchRecipes(searchKey, searchColumn, page, pageSize, sort, sortDirection);
    }
    ...
    public PaginationResponseDTO searchRecipesPage(
      ...
      return recipeService.searchRecipesPage(searchKey, searchColumn, page, pageSize, sort, sortDirection);
    }
}
